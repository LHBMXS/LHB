...
if msg.Director 
and (redis:get(lhb..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(lhb..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(lhb..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(lhb..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)) and MsgText[1] ~= "الغاء" then 
return false end 
...
if not redis:get(lhb..'group:add'..msg.chat_id_) then return sendMsg(msg.chat_id_,msg.id_,'📮¦ بواسطه ⋙「 '..NameUser..' 」 \n📬¦ المجموعه بالتأكيد ✓️ تم تعطيلها \n✓️') end  
...
local edited = (redis:get(lhb..':edited:'..arg.chat_id_..':'..arg.sender_user_id_) or 0)
...
..'📋¦ رسائلك •⊱ {'..arg.msgs..'} ⊰•\n➖'
local Kleshaidinfo = redis:get(lhb..":infoiduser_public:"..arg.chat_id_) or redis:get(lhb..":infoiduser")  

if Kleshaidinfo then 
local points = redis:get(lhb..':User_Points:'..arg.chat_id_..arg.sender_user_id_) or 0
...
KleshaID = KleshaID:gsub("{البوت}",redis:get(lhb..':NameBot:'))
KleshaID = KleshaID:gsub("{المطور}",SUDO_USER)
end
if redis:get(lhb.."idphoto"..msg.chat_id_) then
...
local numvv = redis:get(lhb..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
...
local GroupName = (redis:get(lhb..'group:name'..arg.ChatID) or '')
redis:set(lhb..'linkGroup'..arg.ChatID,(data.invite_link_ or ""))
...
function(arg,data)
if data.ID == "Ok" then
redis:set(lhb..":MsgIDPin:"..arg.ChatID,arg.reply_id)
...
if not msg.Admin then return "📪¦ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not msg.Director and redis:get(lhb..'lock_pin'..msg.chat_id_) then return "لا يمكنك الغاء التثبيت الامر مقفول من قبل الاداره" end
...
elseif UserID == 819385837 or UserID == 879123322  then  
...
elseif redis:sismember(lhb..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد المنشئ\n🛠") 
elseif redis:sismember(lhb..':MONSHA_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد المنشئ الاساسي\n🛠") 
elseif redis:sismember(lhb..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد المدير\n🛠") 
elseif redis:sismember(lhb..'admins:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد الادمن\n🛠") 
elseif  redis:sismember(lhb..'whitelist:'..arg.ChatID,UserID) then 
...
redis:set(lhb..":TqeedUser:"..arg.ChatID..arg.UserID,true)
...
elseif redis:sismember(lhb..':MONSHA_BOT:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"👤*¦* لا يمكنك تقييد المنشئ\n🛠") 
elseif redis:sismember(lhb..':MONSHA_Group:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"👤*¦* لا يمكنك نقييد المنشئ الاساسي\n🛠") 
elseif redis:sismember(lhb..'owners:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"👤*¦* لا يمكنك تقييد المدير\n🛠") 
elseif redis:sismember(lhb..'admins:'..msg.chat_id_,UserID) then 
...
redis:del(lhb..":TqeedUser:"..arg.ChatID..UserID)
GetUserID(UserID,function(arg,data)
NameUser = Hyper_Link_Name(data)
...
redis:del(lhb..":TqeedUser:"..arg.ChatID..arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم فك تقييده  من المجموعه") 
...
NameUser = Hyper_Link_Name(data)
if redis:sismember(lhb..'whitelist:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مميز  في المجموعه") 
else
redis:hset(lhb..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(lhb..'whitelist:'..arg.ChatID,arg.UserID)
...
if redis:sismember(lhb..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مميز  في المجموعه") 
end
redis:hset(lhb..'username:'..UserID,'username',UserName)
redis:sadd(lhb..'whitelist:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مميز  في المجموعه") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
NameUser = Hyper_Link_Name(data)
if not redis:sismember(lhb..'whitelist:'..arg.ChatID,arg.UserID) then 
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(lhb..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مميز  في المجموعه")
else
...
if redis:sismember(lhb..'owners:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مدير  في المجموعه")
else
redis:hset(lhb..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(lhb..'owners:'..arg.ChatID,UserID)
...
UserName = arg.UserName
if redis:sismember(lhb..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مدير  في المجموعه")
else
redis:hset(lhb..'username:'..UserID, 'username',UserName)
redis:sadd(lhb..'owners:'..arg.ChatID,UserID)
...
if not redis:sismember(lhb..'owners:'..arg.ChatID,arg.UserID) then 
...
if not redis:sismember(lhb..'owners:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مدير  في المجموعه")  
else
...
if redis:sismember(lhb..':MONSHA_BOT:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ  في المجموعه") 
else
redis:hset(lhb..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(lhb..':MONSHA_BOT:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(lhb..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ  في المجموعه") 
else
redis:hset(lhb..'username:'..UserID,'username',UserName)
redis:sadd(lhb..':MONSHA_BOT:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه منشئ  في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not redis:sismember(lhb..':MONSHA_BOT:'..arg.ChatID,arg.UserID) then
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(lhb..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ  في المجموعه") 
else
...
ReUsername = ResolveUserName(data)
NameUser   = Hyper_Link_Name(data)
if redis:sismember(lhb..'admins:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه ادمن  في المجموعه") 
else
redis:hset(lhb..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(lhb..'admins:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(lhb..'admins:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه ادمن  في المجموعه") 
else
redis:hset(lhb..'username:'..UserID,'username',UserName)
redis:sadd(lhb..'admins:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه ادمن  في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not redis:sismember(lhb..'admins:'..arg.ChatID,arg.UserID) then 
...
local UserID = data.id_
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(lhb..'admins:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله ادمن  في المجموعه") 
else
...
local maseegs = redis:get(lhb..'msgs:'..arg.UserID..':'..arg.ChatID) or 1
local edited = redis:get(lhb..':edited:'..arg.ChatID..':'..arg.UserID) or 0
local content = redis:get(lhb..':adduser:'..arg.ChatID..':'..arg.UserID) or 0
...
NameUser = Hyper_Link_Name(data)
local maseegs = redis:get(lhb..'msgs:'..UserID..':'..arg.ChatID) or 1
local edited = redis:get(lhb..':edited:'..arg.ChatID..':'..UserID) or 0
local content = redis:get(lhb..':adduser:'..arg.ChatID..':'..UserID) or 0
...
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تنفيذ الامر بالرد ع رسالة البوت \n📛") end
GetUserID(UserID,function(arg,data)
if msg.SudoBase then redis:srem(lhb..'gban_users',arg.UserID)  end 
Restrict(arg.ChatID,arg.UserID,2)
redis:srem(lhb..'banned:'..arg.ChatID,arg.UserID)
StatusLeft(arg.ChatID,arg.UserID)
redis:srem(lhb..'is_silent_users:'..arg.ChatID,arg.UserID)
NameUser = Hyper_Link_Name(data)
...
local UserID = data.id_
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تنفيذ الامر بالرد ع رسالة البوت \n📛") end
if msg.SudoBase then redis:srem(lhb..'gban_users',UserID)  end 
Restrict(arg.ChatID,UserID,2)
redis:srem(lhb..'banned:'..arg.ChatID,UserID)
StatusLeft(arg.ChatID,UserID)
redis:srem(lhb..'is_silent_users:'..arg.ChatID,UserID)
NameUser = Hyper_Link_Name(data)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم رفع القيود ان وجد  \n✓") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
if msg.SudoBase then redis:srem(lhb..'gban_users',MsgText[2])  end 
...
if not msg.Admin then return "📪¦ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not msg.Creator and not redis:get(lhb.."lock_KickBan"..msg.chat_id_) then return "📛*¦* الامر معطل من قبل اداره المجموعة  \n" end
...
NameUser = Hyper_Link_Name(data)
USERNAME = ResolveUserName(data)
if redis:sismember(lhb..'banned:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد حظره  من المجموعه") 
end

redis:hset(lhb..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(lhb..'banned:'..arg.ChatID,arg.UserID)
...
if redis:sismember(lhb..'banned:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد حظره  من المجموعه") 
end
kick_user(UserID,arg.ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
redis:hset(lhb..'username:'..arg.UserID, 'username',arg.UserName)
redis:sadd(lhb..'banned:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم حظره  من المجموعه") 
...
GetChatMember(arg.ChatID,arg.UserID,function(arg,data)
if (data.status_.ID == "ChatMemberStatusKicked" or redis:sismember(lhb..'banned:'..arg.ChatID,arg.UserID)) then
...
UserName = arg.UserName
NameUser = Hyper_Link_Name(data)
if not redis:sismember(lhb..'banned:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد الغاء حظره  من المجموعه") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء حظره  من المجموعه") 
end
...
USERNAME = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(lhb..'is_silent_users:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد كتمه  من المجموعه") 
else
redis:hset(lhb..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(lhb..'is_silent_users:'..arg.ChatID,arg.UserID)
...
if redis:sismember(lhb..'is_silent_users:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد كتمه  من المجموعه") 
else
redis:hset(lhb..'username:'..UserID,'username',UserName)
redis:sadd(lhb..'is_silent_users:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم كتمه  من المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then 
...
if not redis:sismember(lhb..'is_silent_users:'..arg.ChatID,arg.UserID) then 
...
UserName = arg.UserName
NameUser = Hyper_Link_Name(data)
if not redis:sismember(lhb..'is_silent_users:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد الغاء كتمه  من المجموعه") 
else
redis:srem(lhb..'is_silent_users:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء كتمه  من المجموعه") 
...
redis:setex(lhb..'WiCmdLink'..msg.chat_id_..msg.sender_user_id_,500,true)
...
if not redis:get(lhb.."lock_linkk"..msg.chat_id_) then return "📡*¦* الامر معطل من قبل الادارة \n^"  end
if not redis:get(lhb..'linkGroup'..msg.chat_id_) then return "📡*¦* اوه 🙀 لا يوجد رابط ☹️\n🔖*¦*لانشاء رابط ارسل { انشاء رابط } \n📡" end
...
if not msg.Admin then return "📪¦ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:setex(lhb..'rulse:witting'..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:set(lhb..'num_msg_max'..msg.chat_id_,MsgText[2]) 
...
local NumLoop = tonumber(MsgText[2])
redis:set(lhb..':Timer_Cleaner:'..msg.chat_id_,NumLoop) 
...
local Admins = redis:scard(lhb..':MONSHA_Group:'..msg.chat_id_)
if Admins == 0 then  
return "📡*¦* اوه ☢ هنالك خطأ 🚸\n📛¦ عذرا لا يوجد منشئيين اساسييين ليتم مسحهم ✓" 
end
redis:del(lhb..':MONSHA_Group:'..msg.chat_id_)
...
if not msg.Creator then return "📪¦ هذا الامر يخص {المطور,المنشئ} فقط  \n" end
local mmezz = redis:smembers(lhb..":IdsMsgsCleaner:"..msg.chat_id_)
...
if not msg.Admin then return "📪¦ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:setex(lhb..'name:witting'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "📪¦ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:setex(lhb..'about:witting'..msg.chat_id_..msg.sender_user_id_,300,true) 
return "📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل الوصف  للمجموعه\n🛠" 
end

if MsgText[1] == "تاك للكل" then 
if not msg.Admin then return "📪¦ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not redis:get(lhb.."lock_takkl"..msg.chat_id_) then  return "📛*¦* الامر معطل من قبل الادراة" end 
return TagAll(msg) 
end
...
if redis:sismember(lhb..':Filter_Word:'..arg.ChatID,Type_id) then 
return sendMsg(arg.ChatID,arg.MsgID,"📝*¦* هي بالتأكيد في قائمه المنع✓️")
else
redis:sadd(lhb..':Filter_Word:'..arg.ChatID,Type_id) 
...
if redis:sismember(lhb..':Filter_Word:'..arg.ChatID,Type_id) then 
redis:srem(lhb..':Filter_Word:'..arg.ChatID,Type_id) 
...
kick_user(v.user_id_,arg.ChatID,function(arg,data)  
redis:srem(lhb..':MONSHA_BOT:'..arg.ChatID,v.user_id_)
redis:srem(lhb..'whitelist:'..arg.ChatID,v.user_id_)
redis:srem(lhb..'owners:'..arg.ChatID,v.user_id_)
redis:srem(lhb..'admins:'..arg.ChatID,v.user_id_)
end)
end
NumMem = NumMem + 1
...
SUDO_USER = redis:hgetall(lhb..'username:'..SUDO_ID).username
...
if not msg.Admin then return "📪¦ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(lhb..'welcom:witting'..msg.chat_id_..msg.sender_user_id_,true) 
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(lhb..':MONSHA_Group:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ اساسي  في المجموعه") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه منشئ اساسي  في المجموعه") 
redis:hset(lhb..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(lhb..':MONSHA_Group:'..arg.ChatID,arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
local UserID = data.id_
NameUser = Hyper_Link_Name(data)
if redis:sismember(lhb..':MONSHA_Group:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ اساسي  في المجموعه") 
else
redis:hset(lhb..'username:'..UserID,'username',arg.UserName)
redis:sadd(lhb..':MONSHA_Group:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه منشئ اساسي  في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
if not redis:sismember(lhb..':MONSHA_Group:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشئ اساسي  في المجموعه") 
redis:srem(lhb..':MONSHA_Group:'..arg.ChatID,arg.UserID)
end  
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
UserName = Flter_Markdown(arg.UserName)
NameUser = Hyper_Link_Name(data)
if not redis:sismember(lhb..':MONSHA_Group:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه") 
else
redis:srem(lhb..':MONSHA_Group:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشئ اساسي  في المجموعه")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
redis:del(lhb..":awamer_Klesha_m1:")
redis:del(lhb..":awamer_Klesha_m2:")
redis:del(lhb..":awamer_Klesha_m3:")
redis:del(lhb..":awamer_Klesha_mtwr:")
redis:del(lhb..":awamer_Klesha_mrd:")
redis:del(lhb..":awamer_Klesha_mf:")
redis:del(lhb..":awamer_Klesha_m:")
...
redis:del(lhb..":infoiduser_public:"..msg.chat_id_)
...
if not msg.Creator then return "📪¦ هذا الامر يخص {منشئ اساسي,المنشئ,المطور} فقط  \n" end
redis:setex(lhb..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,1000,true)
...
if UserID == 819385837 or UserID == 879123322 then return sendMsg(msg.chat_id_,msg.id_,"📛*¦* لآ يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
...
elseif redis:sismember(lhb..'admins:'..msg.chat_id_,UserID) then 
rinkuser = 6
elseif redis:sismember(lhb..'whitelist:'..msg.chat_id_,UserID) then 
rinkuser = 7
else
rinkuser = 8
end
local DonisDown = "\n📛¦ تم تنزيله من الرتب الاتيه : \n\n "
if redis:sismember(lhb..':SUDO_BOT:',UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من المطور ✓️\n"
end 
if redis:sismember(lhb..':MONSHA_Group:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من المنشئ الاساسي ✓️\n"
end 
if redis:sismember(lhb..':MONSHA_BOT:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من المنشئ ✓️\n"
end 
if redis:sismember(lhb..'owners:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من المدير ✓️\n"
end 
if redis:sismember(lhb..'admins:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من الادمن ✓️\n"
end 
if redis:sismember(lhb..'whitelist:'..msg.chat_id_,UserID) then
...
redis:srem(lhb..':SUDO_BOT:',UserID)
redis:srem(lhb..':MONSHA_Group:'..msg.chat_id_,UserID)
redis:srem(lhb..':MONSHA_BOT:'..msg.chat_id_,UserID)
redis:srem(lhb..'owners:'..msg.chat_id_,UserID)
redis:srem(lhb..'admins:'..msg.chat_id_,UserID)
redis:srem(lhb..'whitelist:'..msg.chat_id_,UserID)
...
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local list = redis:hgetall(lhb..":AwamerBotArray2:"..msg.chat_id_)
local list2 = redis:hgetall(lhb..":AwamerBotArray:"..msg.chat_id_)
...
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Awammer 	= redis:del(lhb..":AwamerBot:"..msg.chat_id_)
redis:del(lhb..":AwamerBotArray:"..msg.chat_id_)
redis:del(lhb..":AwamerBotArray2:"..msg.chat_id_)
if Awammer ~= 0 then
...
for k, lhb in pairs(Xlhb) do if MsgText[2]:match(lhb) then  checkAmr = true end end      
if checkAmr then
redis:setex(lhb..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,300,MsgText[2])
return "📭¦ حسننا عزيزي , لتغير امر {* "..MsgText[2].." *}  ارسل الامر الجديد الان \n..."
else
return "📛*¦* عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره  \n"
end
else
redis:setex(lhb..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if MsgText[2] then
local checkk = redis:hdel(lhb..":AwamerBotArray2:"..msg.chat_id_,MsgText[2])
local AmrOld = redis:hgetall(lhb..":AwamerBotArray:"..msg.chat_id_)
amrnew = ""
amrold = ""
...
redis:hdel(lhb..":AwamerBotArray:"..msg.chat_id_,Amor)
...
redis:setex(lhb..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(lhb..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(lhb..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_,1000,true)
...
NameUser = Hyper_Link_Name(data)
if redis:sismember(lhb..':SUDO_BOT:',arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مطور  في البوت") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مطور  في البوت") 
redis:hset(lhb..'username:'..arg.UserID,'username',RUSERNAME)
redis:sadd(lhb..':SUDO_BOT:',arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
redis:hset(lhb..'username:'..UserID,'username',ReUsername)
redis:sadd(lhb..':SUDO_BOT:',UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مطور  في البوت") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
GetUserID(UserID,function(arg,data)
NameUser = Hyper_Link_Name(data)
if not redis:sismember(lhb..':SUDO_BOT:',arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مطور  في البوت") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مطور  في البوت") 
redis:srem(lhb..':SUDO_BOT:',arg.UserID)
end  
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
local UserID = data.id_
NameUser = Hyper_Link_Name(data)
if not redis:sismember(lhb..':SUDO_BOT:',UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مطور  في البوت") 
else
redis:srem(lhb..':SUDO_BOT:',UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مطور  في البوت") 
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[💯¦ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(lhb..':NameBot:')..[[ 🎖
...
if not msg.SudoUser then return "📪¦ هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(lhb.."lockidedit") then return "📛*¦* الامر معطل من قبل المطور الاساسي  \n" end
redis:del(lhb..":infoiduser")
...
if not msg.SudoUser then return "📪¦ هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(lhb.."lockidedit") then return "📛*¦* تعيين الايدي معطل من قبل المطور الاساسي  \n" end
redis:setex(lhb..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,1000,true)
return '📮*¦* حسننا , الان ارسل كليشه الايدي الجديده \n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n{التفاعل} : لوضع تفاعل المستخدم \n{الرسائل} : لاضهار عدد الرسائل \n{النقاط} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد السحكات \n{البوت} : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n قناه تعليمات ونشر كلايش الايدي \n قناه الكلايش : [@Change_id] \n➼' 
end
...
if not msg.SudoUser then return"📪¦ هذا الامر يخص {المطور} فقط  \n" end
redis:setex(lhb..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,300, true) 
...
redis:hset(lhb..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(lhb..'gban_users',arg.UserID)
...
if redis:sismember(lhb..'gban_users',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد حظره عام  من المجموعات \n✓") 
else
redis:hset(lhb..'username:'..UserID,'username',UserName)
redis:sadd(lhb..'gban_users',UserID)
...
if GeneralBanned(arg.UserID) then 
redis:srem(lhb..'gban_users',arg.UserID)
...
if not redis:sismember(lhb..'gban_users',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد الغاء حظره العام  من المجموعات \n✓") 
else
redis:srem(lhb..'gban_users',UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء حظره العام  من المجموعات \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
if not msg.Admin then return "📪¦ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:del(lhb..'welcom:witting'..msg.chat_id_..msg.sender_user_id_,
lhb..'rulse:witting'..msg.chat_id_..msg.sender_user_id_,
lhb..'name:witting'..msg.chat_id_..msg.sender_user_id_,
lhb..'about:witting'..msg.chat_id_..msg.sender_user_id_,
...
lhb..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,
lhb..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,
lhb..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_,
lhb..'addrd:'..msg.chat_id_..msg.sender_user_id_,
lhb..':KStart:'..msg.chat_id_..msg.sender_user_id_,
lhb.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_,
lhb..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_,
lhb..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_,
lhb..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,
lhb..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,
lhb..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_,
lhb..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_,
lhb..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
lhb..":ForceSub:"..msg.sender_user_id_,
lhb..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,
lhb..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_,
lhb..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_,
lhb..'replay1Random'..msg.chat_id_..msg.sender_user_id_,
lhb..'addrdRandom1:'..msg.sender_user_id_,
lhb..'addrdRandom:'..msg.sender_user_id_,
lhb..'replay1Random'..msg.sender_user_id_)
...
if not msg.SudoBase then return "📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://LHBMXS.github.io/GetVersion.txt') or "0"
...
sendMsg(arg.chat_id_,arg.id_,'📛*¦* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس اللـهـب يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❕')
end  
else
...
local inline = {{{text="قنآهہ‏‏ آلسـورس : اللـهـب 🍃",url="t.me/ASTORHBOTS"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : اللـهـب](t.me/ASTORHBOTS)',nil,inline,msg.id_)
return false
end
...
if not msg.SudoBase then return"📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(lhb..':KStart:'..msg.chat_id_..msg.sender_user_id_,900,true)
...
local file 	= redis:exists(lhb..'replay_files:group:'..msg.chat_id_)
...
lhb..'replay_animation:group:'..msg.chat_id_,lhb..'replay_audio:group:'..msg.chat_id_,lhb..'replay_sticker:group:'..msg.chat_id_,lhb..'replay_video:group:'..msg.chat_id_,lhb..'replay_files:group:'..msg.chat_id_)
...
local file 	= redis:exists(lhb..'replay_files:group:')
if names or photo or voice or imation or audio or sticker or video or file then
redis:del(lhb..'replay:all',lhb..'replay_photo:group:',lhb..'replay_voice:group:',lhb..'replay_animation:group:',lhb..'replay_audio:group:',lhb..'replay_sticker:group:',lhb..'replay_video:group:',lhb..'replay_files:group:')
...
local files 	= redis:hkeys(lhb..'replay_files:group:'..msg.chat_id_)
...
local files 	= redis:hkeys(lhb..'replay_files:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 and #files==0 then 
return '🚸*¦* لا يوجد ردود مضافه حاليا \n❕' 
end
local ii = 1
...
if msg.SudoBase and (MsgText[1]=="م1" or MsgText[1]=="م2" or MsgText[1]=="م3" or MsgText[1]=="م المطور" or MsgText[1]=="اوامر الرد" or MsgText[1]=="الاوامر" or MsgText[1]=="اوامر الملفات") and redis:get(lhb..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(lhb..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_)
redis:setex(lhb..":changawmer:"..msg.chat_id_..msg.sender_user_id_,900,MsgText[1])
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(lhb..":awamer_Klesha_m:")
if textD then
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(lhb..":awamer_Klesha_m1:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(lhb..":awamer_Klesha_m2:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(lhb..":awamer_Klesha_m3:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(lhb..":awamer_Klesha_mtwr:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(lhb..":awamer_Klesha_mrd:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(lhb..":awamer_Klesha_mf:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
if not redis:get(lhb.."lock_leftgroup"..msg.chat_id_) then  return "📛*¦* امر المغادره معطل من قبل اداره المجموعة  \n" end
...
🌐┇اهلا بـك في سورس اللهب  الاقوى 
في عالم التليجرام مميزات حديثه وسهله 
الاستخدام 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📬┇ [Source Channel](https://t.me/ASTORHBOTS)

📊┇ [Source Install](https://t.me/ASTORHBOTS/4121)

🆔┇ [Changing ID Channel](https://t.me/Change_id/1)

📋┇ [Explanation Channel](https://t.me/Sourcelhb/1)

┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
📮┇ [Source Programmer](https://t.me/TH3lhb)

♻️┇ [Twasl Bot Programmer](https://t.me/TH3lhbBOT)
...
if not msg.SudoBase then return "📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
local Get_Files, res = https.request("https://LHBMXS.github.io/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/LHBMXS/LHB.github.io/master/plugins/"..FileName)
if res == 200 then
...
text = [[💯¦ مـرحبآ آنآ بوت آسـمـي []]..redis:get(lhb..':NameBot:')..[[] 🎖
💰¦ آختصـآصـي حمـآيهہ‏‏ آلمـجمـوعآت
📛¦ مـن آلسـبآم وآلتوجيهہ‏‏ وآلتگرآر وآلخ...
...
GetUserID(msg.sender_user_id_,function(arg,data)
if data.last_name_ then Name = data.first_name_ .." "..data.last_name_ else Name = data.first_name_ end
text = redis:get(lhb..':Text_Start') or text
local edited = (redis:get(lhb..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
text = text:gsub("{البوت}",redis:get(lhb..':NameBot:'))
...
local MSG_ID = (redis:get(lhb.."USER_MSG_TWASEL"..data.forward_info_.date_) or 1)
msg = arg.msg
local SendOk = false
...
--====================== Reply Random Public =====================================
if redis:get(lhb..'addrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_) and redis:get(lhb..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_) then
klma = redis:get(lhb..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_)
msg.klma = klma
if msg.text == "تم" then
redis:del(lhb..'addrdRandom1Public:'..msg.chat_id_..msg.sender_user_id_)
redis:del(lhb..'addrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_)
...
redis:sadd(lhb..':KlmatRRandom:',klma) 
redis:sadd(lhb..':ReplayRandom:'..klma,":Text:"..msg.text) 
...
redis:sadd(lhb..':KlmatRRandom:',klma) 
redis:sadd(lhb..':ReplayRandom:'..klma,":Photo:"..photo_id) 
...
elseif msg.content_.ID == "MessageVoice" then
redis:sadd(lhb..':KlmatRRandom:',klma) 
redis:sadd(lhb..':ReplayRandom:'..klma,":Voice:"..msg.content_.voice_.voice_.persistent_id_) 
...
elseif msg.content_.ID == "MessageAnimation" then
redis:sadd(lhb..':KlmatRRandom:',klma) 
redis:sadd(lhb..':ReplayRandom:'..klma,":Animation:"..msg.content_.animation_.animation_.persistent_id_) 
...
elseif msg.content_.ID == "MessageVideo" then
redis:sadd(lhb..':KlmatRRandom:',klma) 
redis:sadd(lhb..':ReplayRandom:'..klma,":Video:"..msg.content_.video_.video_.persistent_id_) 
...
elseif msg.content_.ID == "MessageAudio" then
redis:sadd(lhb..':KlmatRRandom:',klma) 
redis:sadd(lhb..':ReplayRandom:'..klma,":Audio:"..msg.content_.audio_.audio_.persistent_id_) 
...
redis:sadd(lhb..':KlmatRRandom:',klma) 
redis:sadd(lhb..':ReplayRandom:'..klma,":Document:"..msg.content_.document_.document_.persistent_id_) 
...
elseif msg.content_.ID == "MessageSticker" then
redis:sadd(lhb..':KlmatRRandom:',klma) 
redis:sadd(lhb..':ReplayRandom:'..klma,":Sticker:"..msg.content_.sticker_.sticker_.persistent_id_) 
...
if msg.content_.caption_ then redis:hset(lhb..':caption_replay:'..msg.chat_id_,klma,msg.content_.caption_) end
if msg.text then
redis:del(lhb..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
if utf8.len(msg.text) > 4000 then 
return sendMsg(msg.chat_id_,msg.id_,"📛¦ عذرا غير مسموح باضافه جواب الرد باكثر من 4000 حرف تم الغاء الامر\n❕")
end
redis:hset(lhb..'replay:all',klma,msg.text)
...
elseif msg.content_.ID == "MessageVoice" then
redis:hset(lhb..'replay_voice:group:',klma,msg.content_.voice_.voice_.persistent_id_)
redis:del(lhb..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه بصمه صوت للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.content_.ID == "MessageAnimation" then
redis:hset(lhb..'replay_animation:group:',klma,msg.content_.animation_.animation_.persistent_id_)
redis:del(lhb..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه متحركه للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVideo" then
redis:hset(lhb..'replay_video:group:',klma,msg.content_.video_.video_.persistent_id_)
redis:del(lhb..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه فيديو للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.content_.ID == "MessageAudio" then
redis:hset(lhb..'replay_audio:group:',klma,msg.content_.audio_.audio_.persistent_id_)
redis:del(lhb..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه للصوت للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.content_.ID == "MessageDocument" then
redis:hset(lhb..'replay_files:group:',klma,msg.content_.document_.document_.persistent_id_ )
redis:del(lhb..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if msg.Director and (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(lhb.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(lhb.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_)
redis:set(lhb..'linkGroup'..msg.chat_id_,msg.text)
sendMsg(msg.chat_id_,msg.id_,"🔖¦ تم تعيين الرابط بنجاح  ")
return false
end

if msg.Creator and redis:get(lhb..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(lhb..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_)
redis:set(lhb..":infoiduser_public:"..msg.chat_id_,msg.text)
...
if msg.Creator and redis:get(lhb..":changawmer:"..msg.chat_id_..msg.sender_user_id_) and not redis:get(lhb..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
...
local amr = redis:get(lhb..":changawmer:"..msg.chat_id_..msg.sender_user_id_)
if amr == "م1" then
redis:set(lhb..":awamer_Klesha_m1:",msg.text)
elseif amr == "م2" then
redis:set(lhb..":awamer_Klesha_m2:",msg.text)
elseif amr == "م3" then
redis:set(lhb..":awamer_Klesha_m3:",msg.text)
elseif amr == "م المطور" then
redis:set(lhb..":awamer_Klesha_mtwr:",msg.text)
elseif amr == "اوامر الرد" then
redis:set(lhb..":awamer_Klesha_mrd:",msg.text)
elseif amr == "اوامر الملفات" then
redis:set(lhb..":awamer_Klesha_mf:",msg.text)
elseif amr == "الاوامر" then
redis:set(lhb..":awamer_Klesha_m:",msg.text)
end
redis:del(lhb..":changawmer:"..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,"🔖¦ تم تعيين كليشة التعليمات بنجاح \n📮¦ يمكنك تجربة الامر *{"..amr.."}* ")
end


if msg.SudoUser and redis:get(lhb..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(lhb..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_)
redis:set(lhb..":infoiduser",msg.text)
sendMsg(msg.chat_id_,msg.id_,"🔖¦ تم تعيين كليشة الايدي بنجاح \n📮¦ يمكنك تجربة الامر الان ")
return false
end
...
if msg.Director and redis:get(lhb..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_) then
local Awammer 	= redis:hgetall(lhb..":AwamerBotArray2:"..msg.chat_id_)
Amr = redis:get(lhb..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
checknewamr = false
...
for k, lhb in pairs(Xlhb) do 
local cceck,sec = lhb:gsub("[(]"..Amr.."[)]","("..msg.text..")")
print(cceck,sec)
if sec ~= 0 then
redis:hset(lhb..":AwamerBotArray:"..msg.chat_id_,cceck,lhb)
redis:hset(lhb..":AwamerBotArray2:"..msg.chat_id_,msg.text,Amr)
end
end  
redis:hset(lhb..":AwamerBot:"..msg.chat_id_,msg.text,Amr)
sendMsg(msg.chat_id_,msg.id_,"📑¦ تم تغيير الامر القديم ["..Amr.."] \n🔖¦ الى الامر الجديد ["..msg.text.."]\n...")
end
redis:del(lhb..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
return false
end

if msg.Director and not redis:get(lhb..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) and redis:get(lhb..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_) then
local Awammer 	= redis:hgetall(lhb..":AwamerBotArray2:"..msg.chat_id_)
local Amr = redis:get(lhb..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)
...
redis:del(lhb..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)
return false
end

if msg.Director and redis:get(lhb..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) then
local checkAmr = false
for k, lhb in pairs(Xlhb) do if msg.text:match(lhb) then checkAmr = true end end      
if checkAmr then
sendMsg(msg.chat_id_,msg.id_,"📭¦ حسننا عزيزي , لتغير امر {* "..msg.text.." *} \n¦ ارسل الامر الجديد الان \n...")
redis:setex(lhb..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_,900,msg.text)
else
sendMsg(msg.chat_id_,msg.id_,"📛*¦* عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره  \n")
end
redis:del(lhb..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_)
return false
end
...
if msg.Director and redis:get(lhb..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_) then
local checkk = redis:hdel(lhb..":AwamerBotArray2:"..msg.chat_id_,msg.text)
...
redis:del(lhb..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_)
return false
end
...
local checkk = redis:hdel(lhb..":AwamerBot:"..msg.chat_id_,msg.text)
if checkk ~=0 then
tiires =  "📭¦ تم مسح الامر {* "..msg.text.." *} من قائمه الاومر \n..."
else
tiires = "📪¦ هذا الامر ليس موجود ضمن الاوامر المضافه  \n"
...
if msg.SudoBase and redis:get(lhb..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_) then
...
redis:set(lhb..":SUDO_ID:",UserID)
local usero = arg.USERNAME:gsub([[\_]],"_")
redis:hset(lhb..'username:'..UserID,'username',usero)
...
redis:del(lhb..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_)
return false 
end
...
if redis:get(lhb..':KStart:'..msg.chat_id_..msg.sender_user_id_) then
redis:del(lhb..':KStart:'..msg.chat_id_..msg.sender_user_id_)
redis:set(lhb..':Text_Start',msg.text)
...
if redis:get(lhb..'welcom:witting'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(lhb..'welcom:witting'..msg.chat_id_..msg.sender_user_id_) 
redis:set(lhb..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜*¦* تم وضع الترحيب بنجاح كلاتي 👋\n✓" )
end
if redis:get(lhb..'rulse:witting'..msg.chat_id_..msg.sender_user_id_) then --- استقبال القوانين
redis:del(lhb..'rulse:witting'..msg.chat_id_..msg.sender_user_id_) 
...
if redis:get(lhb..'name:witting'..msg.chat_id_..msg.sender_user_id_) then --- استقبال الاسم
redis:del(lhb..'name:witting'..msg.chat_id_..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(lhb..'about:witting'..msg.chat_id_..msg.sender_user_id_) then --- استقبال الوصف
redis:del(lhb..'about:witting'..msg.chat_id_..msg.sender_user_id_) 
...
if redis:get(lhb..':prod_pin:'..msg.chat_id_..msg.sender_user_id_) then 
redis:del(lhb..':prod_pin:'..msg.chat_id_..msg.sender_user_id_)
local groups = redis:smembers(lhb..'group:ids')
if #groups >= 300 then
...
if data.chat_id_ then redis:setex(lhb..":propin"..data.chat_id_,100,data.content_.text_) end
end)
end
...
if msg.forward_info_ and redis:get(lhb..'fwd:'..msg.sender_user_id_) then
...
if not msg.Director and not msg.OurBot and redis:get(lhb..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(lhb..'group:name'..arg.chat_id_,arg.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if msg.content_.ID == "MessageChatAddMembers" and redis:get(lhb..'welcome:get'..msg.chat_id_) then
...
welcome = (redis:get(lhb..'welcome:msg'..msg.chat_id_) or "🔖¦ مرحباً عزيزي\n🔖¦ نورت المجموعة \n💂🏼‍♀️")
welcome = welcome:gsub("{القوانين}", redis:get(lhb..'rulse:msg'..msg.chat_id_) or "🔖¦ مرحبأ عزيري 👋🏻 القوانين كلاتي 👇🏻\n🔖¦ ممنوع نشر الروابط \n🔖¦ ممنوع التكلم او نشر صور اباحيه \n🔖¦ ممنوع  اعاده توجيه \n🔖¦ ممنوع التكلم بلطائفه \n🔖¦ الرجاء احترام المدراء والادمنيه 😅\n")
if msg.addusername then UserName = '@'..msg.addusername else UserName = '< لا يوجد معرف >' end
local edited = (redis:get(lhb..':edited:'..msg.chat_id_..':'..msg.adduser) or 0)
local points = redis:get(lhb..':User_Points:'..msg.chat_id_..msg.adduser) or 0
local msgs = redis:get(lhb..'msgs:'..msg.adduser..':'..msg.chat_id_) or 1

if msg.adduser == SUDO_ID then 
gtupe = 'المطور الاساسي' 
elseif redis:sismember(lhb..':SUDO_BOT:',msg.adduser) then 
gtupe = 'المطور'
elseif msg.GroupActive and redis:sismember(lhb..':MONSHA_Group:'..msg.chat_id_,msg.adduser) then 
gtupe = 'منشئ اساسي'
elseif msg.GroupActive and redis:sismember(lhb..':MONSHA_BOT:'..msg.chat_id_,msg.adduser) then 
gtupe = 'المنشىء'
elseif msg.GroupActive and redis:sismember(lhb..'owners:'..msg.chat_id_,msg.adduser) then 
gtupe = 'المدير' 
elseif msg.GroupActive and redis:sismember(lhb..'admins:'..msg.chat_id_,msg.adduser) then 
gtupe = 'الادمن'
elseif msg.GroupActive and redis:sismember(lhb..'whitelist:'..msg.chat_id_,msg.adduser) then 
gtupe = 'عضو مميز'
...
local welcome = welcome:gsub("{البوت}",redis:get(lhb..':NameBot:'))
...
GetUserID(msg.sender_user_id_,function(arg,data)
welcome = (redis:get(lhb..'welcome:msg'..msg.chat_id_) or "🔖¦ مرحباً عزيزي\n🔖¦ نورت المجموعة \n💂🏼‍♀️")
welcome = welcome:gsub("{القوانين}", redis:get(lhb..'rulse:msg'..msg.chat_id_) or "🔖¦ مرحبأ عزيري 👋🏻 القوانين  👇🏻\n🔖¦ ممنوع نشر الروابط \n🔖¦ ممنوع التكلم او نشر صور اباحيه \n🔖¦ ممنوع  اعاده توجيه \n🔖¦ ممنوع التكلم بلطائفه \n🔖¦ الرجاء احترام المدراء والادمنيه 😅\n")
...
if msg.edited and not msg.SuperCreator and redis:get(lhb.."antiedit"..msg.chat_id_) then 
...
if #monsha ~= 0 then 
for k,v in pairs(monsha) do
local info = redis:hgetall(lhb..'username:'..v) if info and info.username and info.username:match("@[%a%d_]+") then usersmnc = usersmnc..info.username.." - " end
sendMsg(v,0,"📇¦ هناك شخص قام بالتعديل \n👲🏼¦ الاسم : ⋙「 "..NameUser.." 」 "..uuseri.."\n🀄️¦ الايدي : `"..msg.sender_user_id_.."`\n📬¦ رتبته : "..Getrtba(msg.sender_user_id_,msg.chat_id_).."\n🔌¦ نوع التعديل : "..Rwers.."\n📱¦ المجموعة : "..Flter_Markdown((redis:get(lhb..'group:name'..msg.chat_id_) or '')).."\n🔅¦ الرابط : "..redis:get(lhb..'linkGroup'..msg.chat_id_).." \n🚸" )
end
end
...
if not msg.forward_info_ and msg.content_.ID ~= "MessagePhoto" and redis:get(lhb..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(lhb..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_MAX = (redis:get(lhb..'num_msg_max'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_MAX) then 
redis:setex(lhb..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood',30,true)
...
elseif msg.edited and msg.content_.ID ~= "MessageText" and redis:get(lhb..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data) 
...
return false
elseif (msg.text:match("ه‍") or msg.text:match("ی") or msg.text:match("ک")) and redis:get(lhb.."lock_pharsi"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif KlmatMmno3(msg.text) and redis:get(lhb.."lock_mmno3"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("[a-zA-Z]") and redis:get(lhb.."lock_lang"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#.+") and redis:get(lhb..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageDocument" and redis:get(lhb..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageSticker" and redis:get(lhb..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageContact" and redis:get(lhb..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageLocation" and redis:get(lhb..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageVoice" and redis:get(lhb..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageGame" and redis:get(lhb..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageAudio" and redis:get(lhb..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.reply_markup and  msg.reply_markup.ID == "replyMarkupInlineKeyboard" and redis:get(lhb..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(lhb.."lock_RandomRdod"..msg.chat_id_) then 
local Replay = 0
Replay = redis:smembers(lhb..':ReplayRandom:'..msg.text) 
if #Replay ~= 0 then 
...
Caption = redis:hget(lhb..':caption_replay:Random:'..msg.text,CaptionFilter)
...
local Replay = 0
Replay = redis:smembers(lhb..':ReplayRandom:'..msg.chat_id_..":"..msg.text) 
if #Replay ~= 0 then 
local Replay = Replay[math.random(#Replay)]
Replay = convert_Klmat(msg,data,Replay,true)
local CaptionFilter = Replay:gsub(":Text:",""):gsub(":Document:",""):gsub(":Voice:",""):gsub(":Photo:",""):gsub(":Animation:",""):gsub(":Audio:",""):gsub(":Sticker:",""):gsub(":Video:","")
Caption = redis:hget(lhb..':caption_replay:Random:'..msg.chat_id_..msg.text,CaptionFilter)
Caption = convert_Klmat(msg,data,Caption)
if Replay:match(":Text:") then
return sendMsg(msg.chat_id_,msg.id_,Flter_Markdown(Replay:gsub(":Text:","")))
elseif Replay:match(":Document:") then 
...
if redis:get(lhb..'replay'..msg.chat_id_) then
local Replay = false
...
if Replay then 
Caption = redis:hget(lhb..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
print(Caption)
...
Replay = redis:hget(lhb..'replay_files:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(lhb..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(lhb..'replay_files:group:',msg.text)
if Replay then 
Caption = redis:hget(lhb..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendDocument(msg.chat_id_,msg.id_,Replay,Caption)  
...
if msg.text and redis:get(lhb.."lock_rdodSource"..msg.chat_id_) then
