...
if MsgText[1] == 'انجليزي' or MsgText[1] == 'الانجليزي' then
  ...
  name = katu[math.random(#katu)]
  redis:set(lhb..':Set_ang:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(lhb..':Set_ria:'..msg.chat_id_,name)
...
if MsgText[1] == 'تفكيك' then
  ...
  name = katu[math.random(#katu)]
  redis:set(lhb..':Set_fkk:'..msg.chat_id_,name)
  ...
  name = katu[math.random(#katu)]
  redis:set(lhb..':Set_trkib:'..msg.chat_id_,name)
...
♻️│•⊱كت تويت ༜ لعبه التسليه بدون نقاط
...
if msg.text == redis:get(lhb..':Set_ang:'..msg.chat_id_) then -- // النجليزي
redis:incrby(lhb..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(lhb..':Set_ang:'..msg.chat_id_)
